...
if __name__ == '__main__':
    ...
    # video_capture = cv2.VideoCapture('./data/vlc-record-2022-08-25-14h42m13s-3B9ACE48.avi')
    video_capture = cv2.VideoCapture("http://192.168.113.44:8082/rtp/1101010000132000001211010100001320000012.live.flv?token=extract")
    ...
    while ret:
        ...
        ret, frame = video_capture.read()
        cv2.imshow('frame', cv2.cvtColor(np.asarray(image_src), cv2.COLOR_RGB2BGR))
